...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U490M63QX/F78FB9LG0/informe.php?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.7ef51e1a2f5c8d0e676c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U73B8T493");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2017-09-14");
						sb('set', 'name_tag', "oprparis" + '/' + "nelson4722");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>informe.php | oprparis Slack</title>
    ...
    <link href="https://a.slack-edge.com/b4ee0/style/rollup-slack_kit_legacy_adapters.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/37eca6/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/8dbf/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
...
<body class="					feature_name_tagging_client">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/8a4fd5206bd79fdc02dafa79fe14a1ef.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0016-192.png')" data-thumb-size="48" data-member-id="U73B8T493"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/8a4fd5206bd79fdc02dafa79fe14a1ef.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0016-72.png')" data-thumb-size="36" data-member-id="U73B8T493"></span>
				</div>
				<h3>Conectado(a) como</h3>
				<span id="user_menu_name">Nelson4722</span>
			</div>
		</div>
		...
		<div class="nav_contents">
			...
			<ul class="primary_nav">
									<li><a href="/messages" data-qa="app"><i class="ts_icon ts_icon_angle_arrow_up_left"></i>Volver a Slack</a></li>
								<li><a href="/home" data-qa="home"><i class="ts_icon ts_icon_home"></i>Inicio</a></li>
				<li><a href="/account" data-qa="account_profile"><i class="ts_icon ts_icon_user"></i>Cuenta y perfil</a></li>
				<li><a href="/apps/manage" data-qa="configure_apps" target="_blank"><i class="ts_icon ts_icon_plug"></i>Configurar aplicaciones</a></li>
				<li><a href="/files" data-qa="files"><i class="ts_icon ts_icon_all_files clear_blue"></i>Archivos</a></li>
									<li><a href="/team" data-qa="team_directory"><i class="ts_icon ts_icon_team_directory"></i>Directorio</a></li>
				
														<li><a href="/stats" data-qa="statistics"><i class="ts_icon ts_icon_dashboard"></i>Analítica</a></li>
													<li><a href="/customize" data-qa="customize"><i class="ts_icon ts_icon_magic"></i>Personalizar</a></li>
																			<li><a href="/account/team" data-qa="team_settings"><i class="ts_icon ts_icon_cog_o"></i>Ajustes del espacio de trabajo</a></li>
												</ul>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				<li><a href="/is" data-qa="tour">Paseo</a></li>
				<li><a href="/downloads" data-qa="download_apps">Descargar apps</a></li>
				<li><a href="/brand-guidelines" data-qa="brand_guidelines">Directrices de la marca</a></li>
				<li><a href="/help" data-qa="help">Ayuda</a></li>
				<li><a href="https://api.slack.com" target="_blank" data-qa="api">API<i class="ts_icon ts_icon_external_link small_left_margin ts_icon_inherit"></i></a></li>
								<li><a href="/pricing?ui_step=96&ui_element=5" data-qa="pricing" data-clog-event="GROWTH_PRICING" data-clog-ui-element="pricing_link" data-clog-ui-action="click" data-clog-ui-step="admin_footer">Precios</a></li>
				<li><a href="/help/requests/new" data-qa="contact">Contacto</a></li>
				<li><a href="/terms-of-service" data-qa="policies">Políticas</a></li>
				<li><a href="http://slackhq.com/" target="_blank" data-qa="our_blog">Nuestro blog</a></li>
				<li><a href="https://slack.com/signout/141770223121?crumb=s-1506449994-2768e1022b-%E2%98%83" data-qa="sign_out">Desconectarte<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>

			<p id="footer_signature">Hecho con <i class="ts_icon ts_icon_heart"></i> por Slack</p>
...
<header>
			...
			<span class="menu_label">Menú</span>
			...
			<div class="header_btns float_right">
				...
				<a href="/help" id="help_link" data-qa="help_link">
					...
					<span class="block label">Ayuda</span>
							...
							<span class="block label">Iniciar</span>
						</a>
												</div>
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://oprparis.slack.com/home" target="https://oprparis.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            			                            			<i class="team_icon small default" >O</i>
	                            			                            		<span class="switcher_label team_name">oprparis</span>
	                            	</a>
	                            </li>
	                        	                        	                       		<li id="add_team_option"><a href="https://slack.com/signin" target="_blank"><i class="ts_icon ts_icon_plus team_icon small"></i> <span class="switcher_label">Conectarse a otro espacio de trabajo</span></a></li>
...
<p class="print_only">
	...
	Creado por ncariqueor el martes, 26 de septiembre de 2017 a la(s) 15:17
	</strong><br />
	<span class="subtle_silver break_word">https://oprparis.slack.com/files/U490M63QX/F78FB9LG0/informe.php</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Enlace externo: <a class="file_public_link" href="https://slack-files.com/T45NN6K3K-F78FB9LG0-2db5b7993c" target="new">https://slack-files.com/T45NN6K3K-F78FB9LG0-2db5b7993c</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		12KB PHP extracto creado el <span class="date">26 de septiembre de 2017</span>.
				Este archivo es privado.		<span class="file_share_list"></span>
	</p>

	<a id="file_action_cog" class="action_cog action_cog_snippet float_right no_print">
		<span>Acciones </span><i class="ts_icon ts_icon_cog"></i>
	</a>
...
&lt;?php
    ...
    header(&quot;Location: http://panelestxd.cencosud.corp/txd_auth&quot;);
}
?&gt;
</pre>
		...
		<p class="file_page_meta no_print" style="line-height: 1.5rem;">
			<label class="checkbox normal mini float_right no_top_padding no_min_width">
				<input type="checkbox" id="file_preview_wrap_cb"> ajustar líneas largas			</label>
		</p>
	...
	<div class="col span_4_of_6 no_right_padding">
		<div id="file_page_comments">
			...
			<strong class="dull_grey">No puedes ver los comentarios</strong><br />
			Este archivo pertenece a otro espacio.
		</p>
	
	<form action="https://oprparis.slack.com/files/U490M63QX/F78FB9LG0/informe.php"
			id="file_comment_form"
							class="comment_form clearfix"
						method="post">
					<a href="/team/U73B8T493" class="member_preview_link" data-member-id="U73B8T493" >
				<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/8a4fd5206bd79fdc02dafa79fe14a1ef.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0016-72.png')" data-thumb-size="36" data-member-id="U73B8T493"></span>
			</a>
				<input type="hidden" name="addcomment" value="1" />
		<input type="hidden" name="crumb" value="s-1506449994-4aacd52365-☃" />

		<div id="file_comment" class="small texty_comment_input comment_input small_bottom_margin" name="comment" wrap="virtual" ></div>
		<span class="input_note float_left indifferent_grey file_comment_tip">mayús+intro para añadir una nueva línea</span>		<button id="file_comment_submit_btn" type="submit" class="btn float_right  ladda-button" data-style="expand-right"><span class="ladda-label">Añadir comentario</span></button>
	</form>
...
<form
	...
	<input type="submit" class="save btn float_right " value="Guardar" />
	<button class="cancel btn btn_outline float_right small_right_margin ">Cancelar</button>
</form>	
	</div>
	<div class="col span_1_of_6"></div>
</div>
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U73B8T493',
		team_id: 'T45NN6K3K',
		visitor_uid: ".3zlfez7f80owscss4cos4wogo",
		no_login: false,
		version_ts: '1506449287',
		version_uid: '30b95e1e31176248730ae50b9ff65a44075debf3',
	...
	codemirror_files: {
		...
		notification_sounds: [{"value":"b2.mp3","label":"Ding","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/b2.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/b2.ogg"},{"value":"animal_stick.mp3","label":"Boing","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/animal_stick.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/animal_stick.ogg"},{"value":"been_tree.mp3","label":"Drop","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/been_tree.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/been_tree.ogg"},{"value":"complete_quest_requirement.mp3","label":"Tach\u00e1n","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/complete_quest_requirement.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/complete_quest_requirement.ogg"},{"value":"confirm_delivery.mp3","label":"Plink","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/confirm_delivery.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/confirm_delivery.ogg"},{"value":"flitterbug.mp3","label":"Guau","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/flitterbug.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/flitterbug.ogg"},{"value":"here_you_go_lighter.mp3","label":"Aqu\u00ed tienes","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/here_you_go_lighter.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/here_you_go_lighter.ogg"},{"value":"hi_flowers_hit.mp3","label":"Hola","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/hi_flowers_hit.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/hi_flowers_hit.ogg"},{"value":"knock_brush.mp3","label":"Pincelada","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/knock_brush.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/knock_brush.ogg"},{"value":"save_and_checkout.mp3","label":"Whoa!","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/save_and_checkout.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/save_and_checkout.ogg"},{"value":"item_pickup.mp3","label":"Yoink","url":"https:\/\/slack.global.ssl.fastly.net\/7e91\/sounds\/push\/item_pickup.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/item_pickup.ogg"},{"value":"hummus.mp3","label":"Hummus","url":"https:\/\/slack.global.ssl.fastly.net\/7fa9\/sounds\/push\/hummus.mp3","url_ogg":"https:\/\/slack.global.ssl.fastly.net\/46ebb\/sounds\/push\/hummus.ogg"},{"value":"none","label":"Ninguno"}],
		alert_sounds: [{"value":"frog.mp3","label":"Frog","url":"https:\/\/slack.global.ssl.fastly.net\/a34a\/sounds\/frog.mp3"}],
		call_sounds: [{"value":"call\/alert_v2.mp3","label":"Alerta","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/alert_v2.mp3"},{"value":"call\/incoming_ring_v2.mp3","label":"Llamada entrante","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/incoming_ring_v2.mp3"},{"value":"call\/outgoing_ring_v2.mp3","label":"Llamada saliente","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/outgoing_ring_v2.mp3"},{"value":"call\/pop_v2.mp3","label":"Reacci\u00f3n entrante","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/pop_v2.mp3"},{"value":"call\/they_left_call_v2.mp3","label":"Ha abandonado la llamada","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/they_left_call_v2.mp3"},{"value":"call\/you_left_call_v2.mp3","label":"Has abandonado la llamada","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/you_left_call_v2.mp3"},{"value":"call\/they_joined_call_v2.mp3","label":"Se ha unido a la llamada","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/they_joined_call_v2.mp3"},{"value":"call\/you_joined_call_v2.mp3","label":"Te has unido a la llamada","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/you_joined_call_v2.mp3"},{"value":"call\/confirmation_v2.mp3","label":"Confirmaci\u00f3n","url":"https:\/\/slack.global.ssl.fastly.net\/08f7\/sounds\/call\/confirmation_v2.mp3"}],
		...
		feature_slack_astronaut_i18n: true,
		...
		feature_gdrive_removal_warning_copy_update: false,
		...
		feature_ent_user_teams_validate: false,
		...
		feature_workspace_token_apps_in_client: true,
		...
		feature_app_permission_modal_react: true,
	...
	// client boot data
		...
		boot_data.ms_connect_url = "wss:\/\/mpmulti-386E.slack-msgs.com\/?flannel=2&token=xoxs-141770223121-241382922309-240726497521-a105ecd460";
...
//-->
	...
	<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/emoji.es-ES.77de915d82c0ff0314bf.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_libs.es-ES.f8e4afbb82eda2f36842.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_ts.es-ES.55e3af3aa64f32881559.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.es-ES.362474c4146e0047cd0c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_web.es-ES.2c83694b4186aff003ea.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_a_required.es-ES.93dbb2d3e298dbe1c617.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_b_required.es-ES.5cf78c1d63a25af34c9f.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "application" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.es-ES.49032963513e1deed08d.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

			
	
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.comments.es-ES.dec0c5ecbfffa9d07a0b.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.file.es-ES.29539c8209a4e8e21208.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror.min.es-ES.e2bf579bcee157a88b78.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.es-ES.76d72167bd995cf5b4ba.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>


		<script type="text/javascript">
				TS.clog.setTeam('T45NN6K3K');
				TS.clog.setUser('U73B8T493');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F78FB9LG0","created":1506449828,"timestamp":1506449828,"name":"informe.php","title":"informe.php","mimetype":"text\/plain","filetype":"php","pretty_type":"PHP","user":"U490M63QX","editable":true,"size":12180,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T45NN6K3K-F78FB9LG0\/informe.php","url_private_download":"https:\/\/files.slack.com\/files-pri\/T45NN6K3K-F78FB9LG0\/download\/informe.php","permalink":"https:\/\/oprparis.slack.com\/files\/U490M63QX\/F78FB9LG0\/informe.php","permalink_public":"https:\/\/slack-files.com\/T45NN6K3K-F78FB9LG0-2db5b7993c","edit_link":"https:\/\/oprparis.slack.com\/files\/U490M63QX\/F78FB9LG0\/informe.php\/edit","preview":"\u003C?php\r\n\r\nsession_start();\r\n\r\n\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-meta\"\u003E&lt;?php\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-builtin\"\u003Esession_start\u003C\/span\u003E();\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":280,"lines_more":275,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D734Z8N2F"],"comments_count":0};
...
<!-- slack-www-hhvm-0130286f58641cc3e / 2017-09-26 11:19:54 / v30b95e1e31176248730ae50b9ff65a44075debf3 / B:H -->
